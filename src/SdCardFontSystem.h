...
class SdCardFontSystem {
 ...
 private:
  ...
  /// GfxRenderer::setFallbackFont() so CJK titles render in UI chrome.
  ...
  // as a CJK fallback for the corresponding UI font. Use the nearest available
  // size when the font pack does not provide an exact UI size.
